    ...
    return (
      <main className="container">
        <section className="row mt-5">
          ...
          <Link to="/new_task"><button type="button" className="btn btn-light">New Task</button></Link>
          <Link to="/register"><button type="button" className="btn btn-light">Register</button></Link>
          </div>
        </section>
      </main>
